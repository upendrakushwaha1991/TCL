...
public class CommonString {
   ...
   // http://tcl.parinaam.in/webservice/tclservice.svc
   ...
   public static String URL = "http://tcl.parinaam.in/webservice/tclservice.svc/";
    public static String URL3 = "http://tcl.parinaam.in/webservice/tclservice.svc/";
    public static String URLGORIMAG = "http://tcl.parinaam.in/webservice/tclservice.svc/";
